...
% 'Z' axis - These parems has to be defined here since we would like to be able to 
...
% ---------------------------
alpha2 = (1/(2*(Zie_-Zia))) * ( gammaHz*Ge*Tp           + ...
                               (Tp+Ta)*dDNu0_dz(1)      + ...
                               (Ta/(Zfa-Zia))*DNu0(end) - ...
                               (Ta/(Zie_-Zfe_))*DNu0(1) );      % [1/cm^2]
...
if (DEBUG_FLAG >= 5)
	...
	plot_acq_phase_vs_t_1DUF_RHR(z_axis_,DNu0,dDNu0_dz,OmegaE,Tp,te_of_z,ta,dta_,Ga_of_ta,Ge);
end;
