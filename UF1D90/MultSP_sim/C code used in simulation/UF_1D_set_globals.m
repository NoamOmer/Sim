...
global Seq1D;            Seq1D            = 0; 
global Seq2D;            Seq2D            = 1;
...
%   'Z' excitation axis
%  ---------------------
global Zie;              Zie              = -1.30;               % [cm] Excitation z-axis beginning
global Zfe;              Zfe              = +1.30;               % [cm] Excitation z-axis end
global Zia;
global Zfa;
global Lz;               Lz               = abs(Zfe-Zie);        % [cm] Excitation length
global dz;                                                       % [cm] Spatial resolution
global z_axis;                                                   % [cm] Excitation z-axis 
global Ze_INTERP_FACTOR; Ze_INTERP_FACTOR = 4.0;                 %      Interpolate z-axis for higher spatial res.
global alpha1;
global alpha2;
...
%   Excitation
%  ------------
global Tp;               Tp               = 12E-3/Nsp;            % [sec]     Duration of Chirp pulse
global rfwdth;           rfwdth           = Tp + 2E-3;           % [sec]
global Ge;               Ge               = [0,0,11.3];         % [G/cm]    Magnetic field gradient
