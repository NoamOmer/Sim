...
% in angle phi using the RIGHT HAND RULE
% R*(v') = rotated vector
% This function does not rotate the coordinate system but the vector.

% Positive angle + positive unit vector --> counter-clockwise rotation 
% Positive angle + negative unit vector -->         clockwise rotation
% Negative angle + positive unit vector -->         clockwise rotation        
% Negative angle + negative unit vector --> counter-clockwise rotation 

function R = rot_RHR(unit_vec,phi)
