% Design a pre-saturation pulse.
% Application of the pulse must be accompanied by T1 & T2 relaxation,
% (preferably spatially dependent) or spatially dependent field inhomogeneity.
...
function [B_RF_rot,B_RF_t,flip_angle] = gen_presat_pulse(RF_shape,RF_Amp,dt_,center_freq,freq_wdth,phi0,context);
set_context;
...
flip_angle = pulse_T * omega_RF;                    % [rad]
